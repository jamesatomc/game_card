...
import 'package:flutter_cardgame/gamecard/utils/game_utils7.dart';
import 'package:shared_preferences/shared_preferences.dart';

import 'Level8Screen.dart'; // เพิ่ม import สำหรับ SharedPreferences
              ...
              onPressed: () {
                if (score >= 7.5) { // เพิ่มเงื่อนไขตรวจสอบคะแนน
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(content: Text('You need at least 7.5 points to proceed to Level 8.')),
                  );
                }
              },
            ),            
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text('Level 7', style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold)),
                  info_card("Tries", "$tries"),
                  info_card("Score", "${score.toStringAsFixed(1)}"), // แสดง score เป็นทศนิยม 1 ตำแหน่ง
                  info_card(
                      "High Score", "$level7HighScore"), // แสดง high score ของ Level 7
                  info_card(
