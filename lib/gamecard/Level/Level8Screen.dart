              ...
              onPressed: () {
                if (score >= 7.5) { // เพิ่มเงื่อนไขตรวจสอบคะแนน
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(content: Text('You need at least 7.5 points to proceed to Level 9.')),
                  );
                }
              },
            ),                        
  ...
  void checkMatch() {
    if (_game.matchCheck.length == 2) {
      ...
      if (_game.checkMatch(firstIndex, secondIndex)) {
        ...
        setState(() {
          score = score > 1 ? score - 1 : 0; // ลดคะแนน 1.2 คะแนนเมื่อจับคู่ผิด แต่ไม่ติดลบ
        });
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text('Level 8', style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold)),
                  info_card("Tries", "$tries"),
                  info_card("Score", "${score.toStringAsFixed(1)}"), // แสดง score เป็นทศนิยม 1 ตำแหน่ง
                  info_card(
                      "High Score", "$level8HighScore"), // แสดง high score ของ Level 8
                  info_card(
